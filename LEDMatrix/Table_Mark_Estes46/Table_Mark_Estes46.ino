...
#define Wscale              int(BIGGER/ MATRIX_WIDTH)
#define Hscale              int(BIGGER/ MATRIX_HEIGHT)
#ifdef TME_AUDIO
EasyTransfer ETin;
#endif
...
int16_t dot2 = 6,  dot3 = 1, phew, lender = 128, xsizer, ysizer, xx,  yy, flipme = 1, shifty = 4,  poffset, wind = 2, fancy , sinewidth;
