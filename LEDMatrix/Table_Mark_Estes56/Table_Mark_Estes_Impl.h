...
void fakenoise() {
  ...
  for (int16_t i = 0; i <= 16; i++) {
    music.laudio[i] = beatsin8(bpm[i], 1, 63, 32);
    music.raudio[i] = beatsin16(bpm[i + 16], 1, 63, 0);
